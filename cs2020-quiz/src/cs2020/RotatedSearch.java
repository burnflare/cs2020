...
public class RotatedSearch {
	 ...
	 * 
	 * Method works by running through the array in a for loop then checking
	 * if the element after it is smaller than itself. If this is ture, it return
	 * that element.
	 */
	
	public static <T extends Comparable> T searchMax(T[] array) {
